...
- При вызове `gh pr create` не вставляй Markdown-бэктики или другой shell-special текст прямо в `--body "..."`; если body содержит inline code, многострочный Markdown или произвольный пользовательский текст, используй `--body-file`.
